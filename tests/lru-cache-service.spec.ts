...
describe('LRUCacheService', () => {
  ...
  describe('#constructor', () => {
    ...
    it('Set the OptionsMaxLimit#max of LRUCache to the value specified in LRUCacheServiceOptions#maxHostnames to limit number of records in cache.', () => {
